...
def save_query_result(user_query, natural_language_response, result, sql_query, response_text, tokens_first_call=None,
...
if prompt := st.chat_input("Ask about your Snowflake data..."):
    ...
    with st.spinner("Analyzing your query..."):
        try:
            ...
            response_text, token_usage_first_call = get_groq_response(react_system_prompt, st.session_state.messages)
